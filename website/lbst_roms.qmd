...
download_rasters_git = function(save_dir, start_date, end_date){
  ...
  prods <- httr::GET("https://api.github.com/repos/joshcullen/CEG_operationalization/contents/model_prediction/ROMS/rasters")
  ...
  git_url <- glue("https://raw.githubusercontent.com/joshcullen/CEG_operationalization/main/model_prediction/ROMS/rasters/{prod_filt}")
