...
download_rasters_git = function(save_dir, start_date, end_date){
  
  # Find files from repo folder
  prods <- httr::GET("https://api.github.com/repos/joshcullen/CEG_operationalization/contents/model_prediction/TopPredatorWatch/rasters")
  ...
  git_url <- glue("https://raw.githubusercontent.com/joshcullen/CEG_operationalization/main/model_prediction/TopPredatorWatch/rasters/{prod_filt}")
...
# Download files
download_rasters_git(save_dir = "~/Downloads", start_date = "2025-06-25", end_date = "2025-06-30")
